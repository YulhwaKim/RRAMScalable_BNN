...
local BN,parent = torch.class('SplitBatchNormalization', 'nn.Module')
...
function BN:__init(nOutput, groups, eps, momentum, affine)
   parent.__init(self)
   ...
   self.groups = groups or 1 -- for check the groups
